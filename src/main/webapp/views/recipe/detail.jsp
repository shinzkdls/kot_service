                ...
                <div class="single-article-section">
                    ...
                    <div class="class-step">
                        ...
                        <div class="section-title" style="display: flex;justify-content: space-between">
                            <h5>조리 순서</h5><button type="button" id="playStep_btn" style="font-size: 11px;color: #ffffff;font-weight: 700;letter-spacing: 2px;text-transform: uppercase;background: #f28123;border: none;padding: 10px 15px;border-radius: 2px;" >조리 방법 음성 재생</button>
                        </div>
